# type:ignore
# generic_lexer documentation build configuration file, created by
...
htmlhelp_basename = "generic_lexerdoc"
...
man_pages = [
    (master_doc, "generic_lexer", "generic_lexer Documentation", [author], 1)
]
